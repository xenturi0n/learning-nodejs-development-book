...
var geocodeAddress = (address, callback) => {
  ...
  request(
    ...
    (error, response, body) => {
      if (error) {
        callback("Unable to connect Google serveers.");
      } else {
        switch (body.status) {
          case "OK":
          ...
          case "OVER_DAILY_LIMIT":
            ...
            callback("some wrong with your api key");
            break;

          case "OVER_QUERY_LIMIT":
            // indicates that you are over your quota.
            callback("you are over your requests quota.");
            break;

          case "REQUEST_DENIED":
            // indicates that your request was denied.
            callback("your request was denied");
            break;
